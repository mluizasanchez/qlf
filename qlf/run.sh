...
nohup bokeh serve --allow-websocket-origin=localhost:8000 dashboard/bokeh/qasnr dashboard/bokeh/preproc dashboard/bokeh/monitor dashboard/bokeh/exposures dashboard/bokeh/footprint > $QLF_ROOT/bokeh.log 2>&1 &
